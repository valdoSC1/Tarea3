...
namespace Datos
{
    ...
    public partial class Tarea3Entities1 : DbContext
    {
        ...
        public virtual DbSet<Usuarios_Administradores> Usuarios_Administradores { get; set; }
        ...
        public virtual ObjectResult<SP_Logueo_Result> SP_Logueo(string identificacion, string contrasena)
        {
            var identificacionParameter = identificacion != null ?
                new ObjectParameter("identificacion", identificacion) :
                new ObjectParameter("identificacion", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_Logueo_Result>("SP_Logueo", identificacionParameter, contrasenaParameter);
        }
    
        public virtual ObjectResult<SP_LogueoAdmin_Result> SP_LogueoAdmin(string codigoUsuario, string contrasena)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_LogueoAdmin_Result>("SP_LogueoAdmin", codigoUsuarioParameter, contrasenaParameter);
        }
